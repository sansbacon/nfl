...
FOOTBALL_OUTSIDERS_TEAMS = ('ARI', 'ATL', 'BAL', 'BUF', 'CAR', 'CHI', 'CIN',
                            'CLE', 'DAL', 'DEN', 'DET', 'GB', 'HOU', 'IND',
                            'JAC', 'KC', 'MIA', 'MIN', 'NE', 'NO', 'NYG', 'NYJ',
                            'OAK', 'PHI', 'PIT', 'SD', 'SEA', 'SF', 'STL', 'TB',
                            'TEN', 'WAS')
...
TO_NFL = {
    'espn': {
        ...
        'lar': 'LA', 'lac': 'LAC', 'mia': 'MIA', 'min': 'MIN',
        'ne': 'NE', 'no': 'NO', 'nyg': 'NYG', 'nyj': 'NYJ',
        'oak': 'OAK', 'phi': 'PHI', 'pit': 'PIT', 'sd': 'SD',
        'sea': 'SEA', 'sf': 'SF', 'stl': 'STL', 'tb': 'TB', 'was': 'WAS'},
    'fo': {
        'ARI': 'ARI', 'ATL': 'ATL', 'BAL': 'BAL', 'BUF': 'BUF',
        'CAR': 'CAR', 'CHI': 'CHI', 'CIN': 'CIN', 'CLE': 'CLE', 'DAL':
        'DAL', 'DEN': 'DEN', 'DET': 'DET', 'GB': 'GB',
        'HOU': 'HOU', 'IND': 'IND', 'JAC': 'JAX', 'KC': 'KC',
        'SD': 'LAC', 'LARM': 'LAR', 'MIA': 'MIA',
        'MIN': 'MIN', 'NE': 'NE', 'NO': 'NO', 'NYG': 'NYG',
        'NYJ': 'NYJ', 'OAK': 'OAK', 'PHI': 'PHI', 'PIT': 'PIT', 'SF':
        'SF', 'SEA': 'SEA', 'TB': 'TB', 'TEN': 'TEN', 'WAS': 'WAS'
    },

    'pff': {
        'ARZ': 'ARI', 'ATL': 'ATL', 'BLT': 'BAL', 'BUF': 'BUF', 'CAR': 'CAR',
        'CHI': 'CHI', 'CIN': 'CIN',
        'CLV': 'CLE', 'DAL': 'DAL', 'DEN': 'DEN', 'DET': 'DET',
        'GB': 'GB', 'HST': 'HOU',
        'IND': 'IND', 'JAX': 'JAX', 'KC': 'KC', 'SD': 'LAC',
        'LAR': 'LAR', 'MIA': 'MIA',
        'MIN': 'MIN', 'NE': 'NE', 'NO': 'NO', 'NYG': 'NYG',
        'NYJ': 'NYJ', 'OAK': 'OAK',
    ...
    'pfr': {
        ...
        'gnb': 'GB',
        'htx': 'HOU', 'clt': 'IND', 'jax': 'JAX', 'kan': 'KC', 'sdg': 'LAC',
        'ram': 'LAR',
        'mia': 'MIA', 'min': 'MIN', 'nwe': 'NE', 'nor': 'NO', 'nyg': 'NYG',
        'nyj': 'NYJ',
        'rai': 'OAK', 'phi': 'PHI', 'pit': 'PIT', 'sfo': 'SF', 'oti': 'TEN',
        'was': 'WAS'
    },
    ...
    'rg': {
        ...
        'HOU': 'HOU', 'IND': 'IND',
        'JAX': 'JAX', 'KAN': 'KC', 'SDG': 'LAC', 'LAR': 'LAR',
        'MIA': 'MIA', 'MIN': 'MIN',
        'NWE': 'NE', 'NOR': 'NO', 'NYG': 'NYG', 'NYJ': 'NYJ',
        'OAK': 'OAK', 'PHI': 'PHI',
        'PIT': 'PIT', 'SFO': 'SF', 'SEA': 'SEA', 'TAM': 'TB',
        'TEN': 'TEN', 'WAS': 'WAS'
    }
}

FROM_NFL = {
    'pff': {'CHI': 'CHI', 'KC': 'KC', 'DET': 'DET', 'ATL': 'ATL', 'CLE': 'CLV',
            'JAX': 'JAX', 'MIN': 'MIN',
            'DEN': 'DEN',
            'ARI': 'ARZ', 'CIN': 'CIN', 'PIT': 'PIT', 'NYJ': 'NYJ', 'SF': 'SF',
            'TB': 'TB', 'OAK': 'OAK', 'HOU': 'HST',
            'CAR': 'CAR', 'DAL': 'DAL', 'NO': 'NO', 'GB': 'GB', 'BAL': 'BLT',
            'PHI': 'PHI', 'LAR': 'LAR', 'NE': 'NE',
            'NYG': 'NYG', 'WAS': 'WAS', 'SEA': 'SEA', 'TEN': 'TEN', 'BUF': 'BUF',
            'LAC': 'SD', 'IND': 'IND',
            'MIA': 'MIA'},
    'rg': {'CHI': 'CHI', 'KC': 'KAN', 'DET': 'DET', 'ATL': 'ATL', 'CLE': 'CLE',
           'JAX': 'JAX', 'HOU': 'HOU',
           'DEN': 'DEN',
           'ARI': 'ARI', 'CIN': 'CIN', 'PIT': 'PIT', 'NYJ': 'NYJ', 'SF': 'SFO',
           'TB': 'TAM', 'OAK': 'OAK', 'BAL': 'BAL',
           'CAR': 'CAR', 'DAL': 'DAL', 'MIN': 'MIN', 'NO': 'NOR', 'GB': 'GNB',
           'PHI': 'PHI', 'LAR': 'LAR', 'NE': 'NWE',
           'NYG': 'NYG', 'WAS': 'WAS', 'SEA': 'SEA', 'TEN': 'TEN', 'BUF': 'BUF',
           'LAC': 'SDG', 'IND': 'IND',
           'MIA': 'MIA'},
    'pfr': {'CHI': 'chi', 'KC': 'kan', 'DET': 'det', 'LAR': 'ram', 'CLE': 'cle',
            'JAX': 'jax', 'HOU': 'htx',
            'ARI': 'crd',
            'CIN': 'cin', 'PIT': 'pit', 'NYJ': 'nyj', 'SF': 'sfo', 'TB': 'tam',
            'OAK': 'rai', 'MIN': 'min',
            'CAR': 'car',
            'DAL': 'dal', 'NO': 'nor', 'WAS': 'was', 'BAL': 'rav', 'LAC': 'sdg',
            'ATL': 'atl', 'NE': 'nwe',
            'PHI': 'phi',
            'DEN': 'den', 'SEA': 'sea', 'GB': 'gnb', 'TEN': 'oti', 'BUF': 'buf',
            'NYG': 'nyg', 'IND': 'clt',
            'MIA': 'mia'},
    'fo': {'ARI': 'ARI', 'ATL': 'ATL', 'BAL': 'BAL', 'BUF': 'BUF', 'CAR': 'CAR',
           'CHI': 'CHI',
           'CIN': 'CIN', 'CLE': 'CLE', 'DAL': 'DAL', 'DEN': 'DEN', 'DET': 'DET',
           'GB': 'GB', 'HOU': 'HOU',
           'IND': 'IND', 'JAX': 'JAC', 'KC': 'KC', 'LAC': 'SD', 'LAR': 'LARM',
           'MIA': 'MIA', 'MIN': 'MIN',
