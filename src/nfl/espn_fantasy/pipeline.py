"""Pipeline orchestration for ESPN Fantasy data (DEPRECATED).
...
.. deprecated:: 1.0.0
    ...
    transforms and ``nfl.common.storage.persist_tables()`` directly:
        ...
        from nfl.espn_fantasy.transforms_ibis import transform
...
warnings.warn(
    "nfl.espn_fantasy.pipeline is deprecated. "
    "Use nfl.espn_fantasy.transforms_ibis + nfl.common.storage.persist_tables() instead.",
    DeprecationWarning,
    stacklevel=2,
)
