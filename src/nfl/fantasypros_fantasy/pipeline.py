"""Pipeline orchestration for FantasyPros data (DEPRECATED).
...
warnings.warn(
    "nfl.fantasypros_fantasy.pipeline is deprecated. "
    "Use nfl.fantasypros_fantasy.transforms_ibis + nfl.common.storage.persist_tables() instead.",
    DeprecationWarning,
    stacklevel=2,
)
