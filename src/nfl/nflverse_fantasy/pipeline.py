"""Pipeline orchestration for NFLverse data (DEPRECATED).
...
warnings.warn(
    "nfl.nflverse_fantasy.pipeline is deprecated. "
    "Use nfl.nflverse_fantasy.transforms_ibis + nfl.common.storage.persist_tables() instead.",
    DeprecationWarning,
    stacklevel=2,
)
